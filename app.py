...
def ormar():
	if request.method == 'POST':
		...
		db.execute("INSERT INTO Ormar(naziv,velicina,kolicina, datum) VALUES (:naziv,:velicina,:kolicina, :datum)", {"naziv":naziv,"velicina":velicina,"kolicina":kolicina, "datum":datum})
		db.commit()
...
def stalak():
	if request.method == 'POST':
		...
		kolicina = request.form.get('kolicina')
		datum = request.form.get('datum')
		db.execute("INSERT INTO Stalak_za_obucu(naziv,velicina,kolicina, datum) VALUES (:naziv,:velicina,:kolicina, :datum)", {"naziv":naziv,"velicina":velicina,"kolicina":kolicina, "datum":datum})
		db.commit()
